...
import useSearch from '../framework/bigcommerce/products/use-search'
...
export default function Search({
  ...
  console.log('Esta es la categoría activa:')
  console.log(activeCategory)

  const activeBrand = brands.find(
    (b) => getSlug(b.node.path) === `brands/${brand}`
  )?.node
  console.log('Esta es la rama activa:')
    ...
    <Container>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-3 mb-20">
        ...
        <div className="col-span-8 order-3 lg:order-none">
          ...
          {/******************** Aquí es donde se imprimen los productos **********************/}
          {data ? (
            <Grid layout="normal">
              {data.map(({ node }) => (
                <ProductCard
