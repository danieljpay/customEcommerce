...
async function getAllProducts({
  ...
  console.log('impreso después de setear la configuración');
  ...
  console.log('impreso antes de entrar al fetch de config'); //no se imprime
  ...
  console.log('impreso desde get-all-productos' + data);
