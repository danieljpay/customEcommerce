...
const API_URL = 'api_url'//process.env.BIGCOMMERCE_STOREFRONT_API_URL
const API_TOKEN = 'api_token' //process.env.BIGCOMMERCE_STOREFRONT_API_TOKEN
const STORE_API_URL = 'store_api_url' //process.env.BIGCOMMERCE_STORE_API_URL
const STORE_API_TOKEN = 'store_api_token' //process.env.BIGCOMMERCE_STORE_API_TOKEN
const STORE_API_CLIENT_ID = 'store_api_client_id' //process.env.BIGCOMMERCE_STORE_API_CLIENT_ID
const STORE_CHANNEL_ID = 'store_channel_id' //process.env.BIGCOMMERCE_CHANNEL_ID
